...
import edu.mum.cs.cs525.project.ccard.controller.CreditCardController;
...
//        rowdata = new Object[8];
	...
	void JButtonDeposit_actionPerformed(java.awt.event.ActionEvent event)
	{
        ...
        if (selection >=0){
			...
			// depositing money
			AccountEntry accountEntry = new AccountEntry(1234L, "kidus", "kmt", LocalDate.now(), LocalDate.now(), newamount);
			Account account = new Account();
			account.setId("sadf");
			account.setCurrentBalance(newamount);
			ccController.deposit(accountEntry, account);
		}
	...
	void JButtonWithdraw_actionPerformed(java.awt.event.ActionEvent event)
	{
        ...
        if (selection >=0){
			...
			account.setId("accnr");
			account.setCurrentBalance(newamount);
			ccController.withdraw(accountEntry, account);
		}
